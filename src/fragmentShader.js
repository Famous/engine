module.exports = {
    glsl: [
        ...
        //gives the absolute magnitude of the reflectance
        'float distribution(vec3 n, vec3 h, float roughness){',
        '  float m= 2.0/(roughness*roughness) - 2.0;',
        '  return (m+2.0) * pow( max(dot(n, h), 0.0), m) / (2.0 * 3.14159265);',
        '}',

        //computes the specular lobe using the half-angle vector
        //by estimating how much is the microfacet is blocked by other microfacets
