...
This is repository contains the core library of the Famous platform.  At its heart, Famous is a scene graph API for controlling layout.  The core library is a collection of tools that allow for easy construction of graphs as well as the plumbing to communicate relative information in a performant and elegant manner.
