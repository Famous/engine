...
This is a library of components to use with the [Famous]() platform.  Components are designed to be attached onto nodes in the scene graph and provide an interface for manipulating layout, creating draw commands, handling eventing, or managing custom any logic.
