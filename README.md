...
Router is a module designed to give access to URL changes in the browser.  While it is designed to be used with the Famous platform, it can be used in any client-side application. 
