...
transitions is a library for transitioning between numbers or sets of numbers.  The transition library also comes with a collection of curves that are used to tween between the start and end states.  Transitions is used in the Famous platform but is well suited to be used in any project.
