...
webgl-renderables are a library of components designed to be added to a scene in the Famous platform.  These renderables expose an interface for manipulating how particular WebGL objects should look and then turns that into draw commands sent to the renderer.
...
- [famous-transitions](https://github.com/Famous/transitions)
