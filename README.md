...
webgl-materials is a module designed to aid in importing textures and combining chunks of WebGL shader code that can be applied to a Mesh.  The materials that are generated are designed to be used with the Famous platform.
