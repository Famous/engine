...
utilities is a library of useful helper classes and functions.  These serve a variety of purposes such as state management and a key code lookup.  These are used in the Famous platform but are well suited to be used in any project.
